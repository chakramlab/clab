...
def bs_mode_nth_heated(
    device_setup,
    serial_num,
    qubit_params_file_path,
    exp_id="bs_mode_nth_heated",
    ...
    with exp.acquire_loop_rt(
        ...
        with exp.sweep(
            ...
            with exp.sweep(
                ...
                if play_alice_ge:
                    with exp.section(uid="ge_excitation", play_after="bs", on_system_grid=True):
                        exp.play(
                            signal="qb_drive",
                            pulse=ge_X180,
                        )
                ...
                with exp.section(uid="fe_excitation", play_after="ge_excitation2", on_system_grid=True):
                    exp.play(
                        signal="qb_ef_drive", 
                        pulse=ef_X180, 
                    )

                with exp.section(uid="readout", play_after="fe_excitation", on_system_grid=True):
                    exp.measure(
