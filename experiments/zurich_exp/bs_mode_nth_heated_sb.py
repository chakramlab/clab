        ...
        with exp.sweep(
            ...
            with exp.sweep(
                ...
                with exp.section(
                    ...
                    exp.play(
                        signal="bs", pulse=bs, length=bs_length, amplitude=bs_amplitude
                    )
                play_after = "bs"
                ...
                with exp.section(
                    uid="ge_excitation2", play_after="ef", on_system_grid=True
                ):
                    exp.play(
                        signal="qb_drive",
                        pulse=ge_X180,
                ...
                with exp.section(
                    uid="readout", play_after="fe_excitation", on_system_grid=True
                ):
                    exp.measure(
