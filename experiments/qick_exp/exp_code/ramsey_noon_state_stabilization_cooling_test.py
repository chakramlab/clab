...
class RamseyNOONStateStabilizationCoolingTestProgram(AveragerProgram):
    def initialize(self):
...
class RamseyNOONStateStabilizationCoolingTestExperiment(Experiment):
    ...
    def acquire(self, progress=False, debug=False, data_path=None, filename=None):
        ...
        for ii in tqdm(range(self.cfg.expt.expts), total=len(range(self.cfg.expt.expts))):
            ...
            wigtom=RamseyNOONStateStabilizationCoolingTestProgram(soc, self.cfg)
