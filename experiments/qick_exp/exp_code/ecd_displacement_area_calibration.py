...
class ECDDisplacementAreaCalibrationProgram(AveragerProgram):
    def initialize(self):
...
class ECDDisplacementAreaCalibrationExperiment(Experiment):
    ...
    def acquire(self, progress=False, data_path=None, filename=None):
        ...
        for ii in tqdm(self.cfg.expt.cavity_drive_gains, disable=not progress):
            ...
            lenrabi = ECDDisplacementAreaCalibrationProgram(soc, self.cfg)       
