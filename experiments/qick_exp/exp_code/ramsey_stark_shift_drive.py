...
class RamseyStarkShiftDriveProgram(AveragerProgram):
    def initialize(self):
...
class RamseyStarkShiftDriveExperiment(Experiment):
    ...
    def acquire(self, progress=False, data_path=None, filename=None):
        ...
        for i in tqdm(np.arange(len(x_pts)), disable = not progress):
            ...
            ramsey_echo = RamseyStarkShiftDriveProgram(soc, self.cfg)
