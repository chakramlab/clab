...
class PhotonNumberResolvedQSpecProgram(AveragerProgram):
    def initialize(self):
    ...
    def body(self):
        ...
        if cfg.expt.reset:
            ...
            if cfg.expt.qubit_reset_only:
                ...
                self.cfg.device.soc.readout.reset_cavity_n = cfg.expt.reset_n 
                ...
                for jj in range(cfg.device.soc.readout.reset_cycles):
                    ...
                    for kk in range(cfg.device.soc.readout.reset_cavity_n, 0, -1):
                        ...
                        self.play_pi_ef(shift = (kk)*chi_ef_cor)
                        self.sync_all()
