...
class LengthRabiProgram(AveragerProgram):
    def initialize(self):
        ...
        self.sigma_test = self.us2cycles(self.cfg.expt.length_placeholder, gen_ch=self.qubit_ch)
        ...
        if self.cfg.expt.pulse_type.lower() == "gauss" and self.cfg.expt.length_placeholder != 0:
            ...
            self.set_pulse_registers(
                ...
                waveform="qubit")
        elif self.cfg.expt.pulse_type.lower() == "const" and self.cfg.expt.length_placeholder != 0:
            self.set_pulse_registers(
                ch=self.qubit_ch,
                style="const",
                freq=self.freq2reg(cfg.device.soc.qubit.f_ge),
