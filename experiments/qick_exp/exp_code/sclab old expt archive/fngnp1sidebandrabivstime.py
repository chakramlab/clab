...
class fngnp1RabiProgram(AveragerProgram):
    ...
    def body(self):
        ...
        for i in np.arange(cfg.expt.n):
            ...
            if self.cfg.device.soc.qubit.pulses.pi_ge.pulse_type == 'const':
                ...
                self.set_pulse_registers(
                        ch=self.qubit_ch, 
                        style="const", 
                        freq=self.freq2reg(cfg.device.soc.qubit.f_ge + chi_ge_cor), 
                        phase=0,
            ...
            if self.cfg.device.soc.qubit.pulses.pi_ge.pulse_type == 'gauss':
                ...
                print('ge freq', cfg.device.soc.qubit.f_ge + chi_ge_cor)
                self.set_pulse_registers(
                    ch=self.qubit_ch,
                    style="arb",
                    freq=self.freq2reg(cfg.device.soc.qubit.f_ge + chi_ge_cor),
            ...
            if self.pulse_type_ef == 'const':
                ...
                self.set_pulse_registers(
                        ch=self.qubit_ch, 
                        style="const", 
                        freq=self.freq2reg(cfg.device.soc.qubit.f_ef + chi_ef_cor), 
                        phase=0,
            ...
            if self.pulse_type_ef == 'gauss':
                ...
                print('ef freq', cfg.device.soc.qubit.f_ef + chi_ef_cor)
                self.set_pulse_registers(
                    ch=self.qubit_ch,
                    style="arb",
                    freq=self.freq2reg(cfg.device.soc.qubit.f_ef + chi_ef_cor),
            ...
            print('sideband freq', cfg.device.soc.sideband.fngnp1_freqs[cfg.expt.mode][i])
            self.set_pulse_registers(
                ch=self.sideband_ch,
                style="const",
        ...
        if self.pulse_type_ge == 'gauss':
            ...
            print('playing pi_ge gauss')
            print('length', cfg.device.soc.qubit.pulses.pi_ge.sigma)
            print('freq', cfg.device.soc.qubit.f_ge + chi_ge_cor)
        ...
        if self.pulse_type_ef == 'gauss':
            ...
            print('playing pi_ef gauss')
            print('length', cfg.device.soc.qubit.pulses.pi_ef.sigma)
            print('freq', cfg.device.soc.qubit.f_ef + chi_ef_cor)
        ...
        print('playing sideband')
        print('freq', cfg.expt.freq)
        print('gain', self.cfg.expt.gain)
        print('length', self.cfg.expt.length_placeholder)
        self.set_pulse_registers(
            ch=self.sideband_ch,
            style="const",
