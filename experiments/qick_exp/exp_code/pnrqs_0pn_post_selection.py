...
class PhotonNumberResolvedQSpec0pNPostSelectionProgram(AveragerProgram):
    def initialize(self):
...
class PhotonNumberResolvedQSpec0pNPostSelectionExperiment(Experiment):
    ...
    def acquire(self, progress=False, debug=False, data_path=None, filename=None):
        ...
        for i in tqdm(fpts, disable = not progress):
            ...
            qspec=PhotonNumberResolvedQSpec0pNPostSelectionProgram(soc, self.cfg)
