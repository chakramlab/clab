...
class NOONStateCoherenceSweepPhaseTestProgram(AveragerProgram):
    def initialize(self):
...
class NOONStateCoherenceSweepPhaseTestExperiment(Experiment):
    ...
    def acquire(self, progress=False, debug=False, data_path=None, filename=None):
        ...
        for ii in tqdm(phases, total=len(phases)):
            ...
            wigtom=NOONStateCoherenceSweepPhaseTestProgram(soc, self.cfg)
