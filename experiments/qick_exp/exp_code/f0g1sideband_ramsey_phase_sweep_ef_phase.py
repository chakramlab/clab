...
class f0g1SidebandRamseyPhaseSweepEFPhaseProgram(AveragerProgram):
    def initialize(self):
...
class f0g1SidebandRamseyPhaseSweepEFPhaseExperiment(Experiment):
    """T1 Experiment
       Experimental Config
    ...
    def acquire(self, progress=False, debug=False, data_path=None, filename=None):
        ...
        for phase in tqdm(xpts, disable = not progress):
            ...
            t1 = f0g1SidebandRamseyPhaseSweepEFPhaseProgram(soc, self.cfg)
