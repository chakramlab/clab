...
class NOONStateCoherenceSweepPhaseProgram(AveragerProgram):
    def initialize(self):
...
class NOONStateCoherenceSweepPhaseExperiment(Experiment):
    ...
    def acquire(self, progress=False, debug=False, data_path=None, filename=None):
        ...
        for ii in tqdm(phases, total=len(phases)):
            ...
            wigtom=NOONStateCoherenceSweepPhaseProgram(soc, self.cfg)
