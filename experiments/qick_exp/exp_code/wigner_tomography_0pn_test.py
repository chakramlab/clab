...
class WignerTomography0pnTestProgram(AveragerProgram):
    def initialize(self):
...
class WignerTomography0pnTestExperiment(Experiment):
    ...
    def acquire(self, progress=False, debug=False, data_path=None, filename=None):
        ...
        for i,j in tqdm(zip(cavdr_gains, cavdr_phases), total=len(cavdr_gains), disable = not progress):
            ...
            wigtom=WignerTomography0pnTestProgram(soc, self.cfg)
