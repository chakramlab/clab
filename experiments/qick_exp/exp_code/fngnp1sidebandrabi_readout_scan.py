...
class fngnp1SpectroscopyReadoutProgram(RAveragerProgram):
    def initialize(self):
...
class fngnp1SpectroscopyReadoutExperiment(Experiment):
    ...
    def acquire(self, progress=False, debug=False, data_path=None, filename=None):
        ...
        qspec_ef=fngnp1SpectroscopyReadoutProgram(soc, self.cfg)
