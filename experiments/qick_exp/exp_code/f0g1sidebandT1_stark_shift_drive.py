...
class f0g1sidebandT1StarkShiftDriveProgram(RAveragerProgram):
    def initialize(self):
...
class f0g1sidebandT1StarkShiftDriveExperiment(Experiment):
    """T1 Experiment
       Experimental Config
    ...
    def acquire(self, progress=False, debug=False, data_path=None, filename=None):
        ...
        for i in tqdm(np.arange(len(x_pts)), disable = not progress):
            ...
            t1 = f0g1sidebandT1StarkShiftDriveProgram(soc, self.cfg)
