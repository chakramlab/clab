...
class RamseyNOONStateStabilizationProgram(AveragerProgram):
    def initialize(self):
...
class RamseyNOONStateStabilizationExperiment(Experiment):
    ...
    def acquire(self, progress=False, debug=False, data_path=None, filename=None):
        ...
        for ii in tqdm(range(self.cfg.expt.expts), total=len(range(self.cfg.expt.expts))):
            ...
            wigtom=RamseyNOONStateStabilizationProgram(soc, self.cfg)
