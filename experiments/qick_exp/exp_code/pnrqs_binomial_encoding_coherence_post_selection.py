...
class PNRQSBinomialEncodingCoherencePostSelectionProgram(AveragerProgram):
    def initialize(self):
    ...
    def body(self):
        ...
        # Play decoding recovery sequence
...
class PNRQSBinomialEncodingCoherencePostSelectionExperiment(Experiment):
    ...
    def acquire(self, progress=False, debug=False, data_path=None, filename=None):
        ...
        for i in tqdm(tpts, disable = not progress):
            ...
            qspec=PNRQSBinomialEncodingCoherencePostSelectionProgram(soc, self.cfg)
