...
class PNRQSSidebandOptimalControlProgram(AveragerProgram):
    def initialize(self):
...
class PNRQSSidebandOptimalControlExperiment(Experiment):
    ...
    def acquire(self, progress=False, debug=False, data_path=None, filename=None):
        ...
        for i in tqdm(xpts, disable = not progress):
            ...
            qspec=PNRQSSidebandOptimalControlProgram(soc, self.cfg)
