...
class fngnp1RabiProgram(AveragerProgram):
    ...
    def body(self):
        ...
        self.play_sb(freq=cfg.expt.freq, length=self.sigma_fngnp1, gain=cfg.expt.gain, pulse_type=self.cfg.device.soc.sideband.pulses.fngnp1pi_pulse_types[self.cfg.expt.mode], ramp_type=self.cfg.expt.flat_top_type, ramp_sigma=self.cfg.expt.sb_sigma, phase=0)
        self.sync_all()
